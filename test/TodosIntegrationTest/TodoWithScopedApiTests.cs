...
{
    public class TodoWithScopedApiTests : TestBase, IClassFixture<TestFixture<TodoWithScopedApi.Program>>
    {
        private const string ApiUrl = "/api/todos";
        private readonly HttpClient _client;

        public TodoWithScopedApiTests(TestFixture<TodoWithScopedApi.Program> fixture)
        {
