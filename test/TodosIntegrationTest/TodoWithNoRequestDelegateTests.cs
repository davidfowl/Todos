...
{
    public class TodoWithNoRequestDelegateTests : TestBase, IClassFixture<TestFixture<TodoWithNoRequestDelegate.Program>>
    {
        private const string ApiUrl = "/api/todos";
        private readonly HttpClient _client;

        public TodoWithNoRequestDelegateTests(TestFixture<TodoWithNoRequestDelegate.Program> fixture)
        {
