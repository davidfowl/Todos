...
namespace TodoWithScopedApi.IntegrationTest
{
    public class TodoWithScopedApiTests : IClassFixture<TestFixture>
    {
        private const string ApiUrl = "/api/todos";
        private readonly HttpClient _client;

        public TodoWithScopedApiTests(TestFixture fixture)
        {
